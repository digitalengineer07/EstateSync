        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5 overflow-y-auto">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="0.00"
                  className="w-full pl-8 pr-4 py-2 text-sm font-bold text-slate-900 border border-slate-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                />
              </div>
          ...
          <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/70 space-y-2">
            <div className="flex items-center justify-between text-xs">
              ...
              <span className={`font-black ${
                calculatedDelta > 0 ? "text-emerald-700" : calculatedDelta < 0 ? "text-rose-700" : "text-slate-400"
              }`}>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3.5 py-2 text-xs border border-slate-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-slate-900"
            />
            <div className="flex justify-between items-center mt-1">
              <span className="text-[11px] text-slate-400">Minimum 5 characters required for audit trail.</span>
              <span className={`text-[11px] font-semibold ${reason.trim().length >= 5 ? "text-emerald-600" : "text-slate-400"}`}>
