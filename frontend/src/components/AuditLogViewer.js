...
export default function AuditLogViewer() {
  ...
  const getActionBadge = (action) => {
    switch (action) {
      case "EXPENSE_REVERSE":
        return <span className="inline-flex items-center px-2.5 py-0.5 text-[11px] font-bold bg-orange-50 text-orange-700 rounded-md border border-orange-200/90">EXPENSE_REVERSE</span>;
      case "EXPENSE_CREATE":
        return <span className="inline-flex items-center px-2.5 py-0.5 text-[11px] font-bold bg-orange-50 text-orange-700 rounded-md border border-orange-200/90">EXPENSE_CREATE</span>;
      ...
      case "CUSTOMER_PAYMENT_RECORD":
        return <span className="inline-flex items-center px-2.5 py-0.5 text-[11px] font-bold bg-orange-50 text-orange-700 rounded-md border border-orange-200/90">CUSTOMER_PAYMENT</span>;
      case "PROPERTY_CREATE":
        return <span className="inline-flex items-center px-2.5 py-0.5 text-[11px] font-bold bg-orange-50 text-orange-700 rounded-md border border-orange-200/90">PROPERTY_CREATE</span>;
      ...
      case "FUND_DIRECT_ALLOCATE":
        return <span className="inline-flex items-center px-2.5 py-0.5 text-[11px] font-bold bg-orange-50 text-orange-700 rounded-md border border-orange-200/90">FUND_ALLOCATE</span>;
      ...
      case "USER_LOGIN":
        return <span className="inline-flex items-center px-2.5 py-0.5 text-[11px] font-bold bg-orange-50 text-orange-700 rounded-md border border-orange-200/90">USER_LOGIN</span>;
      case "USER_REGISTER":
        return <span className="inline-flex items-center px-2.5 py-0.5 text-[11px] font-bold bg-orange-50 text-orange-700 rounded-md border border-orange-200/90">USER_REGISTER</span>;
      case "EMPLOYEE_CREATE":
        return <span className="inline-flex items-center px-2.5 py-0.5 text-[11px] font-bold bg-orange-50 text-orange-700 rounded-md border border-orange-200/90">EMPLOYEE_CREATE</span>;
      case "EMPLOYEE_UPDATE":
        return <span className="inline-flex items-center px-2.5 py-0.5 text-[11px] font-bold bg-orange-50 text-orange-700 rounded-md border border-orange-200/90">EMPLOYEE_UPDATE</span>;
      case "EMPLOYEE_SALARY_CONFIG_UPDATE":
        return <span className="inline-flex items-center px-2.5 py-0.5 text-[11px] font-bold bg-orange-50 text-orange-700 rounded-md border border-orange-200/90">SALARY_CONFIG_UPDATE</span>;
      case "SALARY_PAYMENT_DISBURSED":
        return <span className="inline-flex items-center px-2.5 py-0.5 text-[11px] font-bold bg-orange-50 text-orange-700 rounded-md border border-orange-200/90">SALARY_DISBURSED</span>;
      case "SALARY_STRUCTURE_UPDATED":
        return <span className="inline-flex items-center px-2.5 py-0.5 text-[11px] font-bold bg-orange-50 text-orange-700 rounded-md border border-orange-200/90">SALARY_UPDATED</span>;
      case "TREASURY_INFLOW_RECORD":
        return <span className="inline-flex items-center px-2.5 py-0.5 text-[11px] font-bold bg-orange-50 text-orange-700 rounded-md border border-orange-200/90">TREASURY_INFLOW</span>;
      default:
  ...
  const renderPayload = (log) => {
    ...
    if (log.action === "SALARY_PAYMENT_DISBURSED") {
      return (
        <div className="flex flex-wrap items-center gap-1.5 max-w-lg">
          {payload.amount && (
            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md bg-orange-50 border border-orange-200/90 text-orange-800 text-xs font-bold font-sans">
    ...
    if (log.action === "EMPLOYEE_SALARY_CONFIG_UPDATE") {
      ...
      return (
        <div className="flex flex-wrap items-center gap-1.5 max-w-lg">
          ...
          {payload.baseSalary && (
            <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-md bg-orange-50 border border-orange-200/90 text-orange-800 text-xs font-bold font-sans">
    ...
    if (log.action === "EMPLOYEE_CREATE" || log.action === "EMPLOYEE_UPDATE") {
      ...
      return (
        <div className="flex flex-wrap items-center gap-1.5 max-w-lg">
          ...
          {payload.department && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-orange-50 border border-orange-100 text-orange-700 text-[11px] font-medium">
          ...
          {payload.status && (
            <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-md bg-orange-50 border border-orange-200 text-orange-700 text-[10.5px] font-bold">
              {payload.status}
            </span>
          )}
        </div>
    ...
    if (log.action === "USER_LOGIN" && payload.role) {
      return (
        <span className="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-orange-50/70 border border-orange-200/80 text-orange-900 text-xs font-semibold shadow-2xs">
          <span className="w-1.5 h-1.5 rounded-full bg-orange-600 animate-pulse"></span>
          <span className="text-orange-500 font-medium text-[11px]">Role Authority:</span>
          <span className="font-bold text-orange-950">{payload.role}</span>
        </span>
      );
    }
        ...
        {entries.slice(0, 5).map(([k, v]) => {
          ...
          return (
            <span key={k} className="inline-flex items-center gap-1 text-[11px] bg-slate-50 border border-slate-200/90 rounded-md px-2 py-0.5">
              ...
              <span className={`font-semibold ${isAmount ? "text-orange-700 font-sans" : "text-slate-800"}`}>
  ...
  return (
    <div className="bg-white rounded-2xl sm:rounded-[22px] border border-slate-200/90 shadow-[0_4px_24px_-6px_rgba(0,0,0,0.04)] p-6 sm:p-7 mt-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 pb-5 border-b border-slate-100">
        ...
        <div className="flex items-center gap-2.5 self-start sm:self-auto">
          <select
            ...
            className="text-xs border border-slate-200 rounded-xl px-3 py-2 bg-slate-50/80 text-slate-700 focus:bg-white focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-600 transition font-medium"
          >
      ...
      {error && !data && (
        <div className="p-4 bg-orange-50 text-orange-900 border border-orange-200 rounded-xl text-xs">
          {error}
        </div>
      )}
