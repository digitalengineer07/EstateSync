        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-700 mb-1.5">
              Monthly Base Salary (₹) <span className="text-orange-500">*</span>
            </label>
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-8 pr-4 py-2.5 rounded-xl border border-slate-200 text-sm text-slate-900 font-semibold placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-600 transition"
              />
            </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-600 transition"
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-slate-200 bg-white text-xs text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-orange-600"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  maxLength={11}
                  className="w-full px-3 py-2 rounded-lg border border-slate-200 bg-white text-xs text-slate-900 font-mono placeholder:text-slate-400 uppercase focus:outline-none focus:border-orange-600"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-slate-200 bg-white text-xs text-slate-900 font-mono placeholder:text-slate-400 focus:outline-none focus:border-orange-600"
                />
              </div>
          ...
          <div className="p-3 rounded-lg bg-orange-50/60 border border-orange-100 flex items-start gap-2 text-xs text-orange-900">
