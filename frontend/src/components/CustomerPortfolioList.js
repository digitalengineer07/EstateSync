        ...
        <div className="flex items-center gap-2.5">
          {canRegisterCustomer && (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-orange-600 hover:bg-orange-700 active:scale-95 text-white text-xs font-semibold rounded-lg shadow-xs transition"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 my-5">
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200/90 shadow-[0_1px_3px_rgba(0,0,0,0.03)] hover:shadow-md hover:border-slate-300/80 transition-all duration-200 flex flex-col justify-between">
            ...
            <div className="text-xs text-slate-500 mt-3 pt-2.5 border-t border-slate-100 flex items-center justify-between">
              ...
              <span className="text-orange-700 font-semibold text-[11px] bg-orange-50 px-1.5 py-0.5 rounded">Active</span>
            </div>
          </div>
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200/90 shadow-[0_1px_3px_rgba(0,0,0,0.03)] hover:shadow-md hover:border-slate-300/80 transition-all duration-200 flex flex-col justify-between">
            <div>
              ...
              <div className="mt-3">
                <span className="text-xl sm:text-[22px] font-bold text-orange-700 tracking-tight font-digital block">
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200/90 shadow-[0_1px_3px_rgba(0,0,0,0.03)] hover:shadow-md hover:border-slate-300/80 transition-all duration-200 flex flex-col justify-between">
            ...
            <div className="text-xs text-slate-500 mt-3 pt-2.5 border-t border-slate-100 flex items-center justify-between">
              ...
              <span className="text-orange-600 font-semibold text-[11px]">Due for collection</span>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 mb-5">
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full text-xs border border-slate-200 rounded-xl pl-9 pr-8 py-2.5 focus:ring-2 focus:ring-orange-500/20 focus:border-orange-600 focus:outline-none bg-slate-50/70 transition"
          />
          {search && (
            <button
              onClick={() => setSearch("")}
                  ...
                  >
                    ...
                    <td className="px-4 py-3.5 min-w-[160px]">
                      ...
                      <div className="w-full bg-slate-100 rounded-full h-1.5 overflow-hidden">
                        <div
                          className={`h-1.5 rounded-full transition-all ${pct === 100 ? "bg-orange-500" : pct > 50 ? "bg-orange-600" : "bg-orange-500"}`}
                          style={{ width: `${pct}%` }}
                        ></div>
                      </div>
                    ...
                    <td className="px-4 py-3.5 text-right space-x-1.5" onClick={(e) => e.stopPropagation()}>
                      ...
                      {canRecordPayment && cust.status === 'ACTIVE' && due > 0 && (
                        <button
                          ...
                          className="px-3 py-1 text-[11px] font-bold text-white bg-orange-600 hover:bg-orange-700 rounded-md shadow-xs transition active:scale-95"
                        >
                          + Record Payment
                        </button>
                      )}
