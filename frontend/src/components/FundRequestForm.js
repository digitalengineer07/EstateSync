            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  {formData.amount && (
                    <span className="font-digital text-xs font-bold text-orange-700">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full text-xs sm:text-sm px-3.5 py-2.5 rounded-xl border border-slate-200 bg-slate-50/70 focus:bg-white focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-600 transition text-slate-900 font-medium font-digital"
                ...
                <div className="flex items-center gap-1.5 mt-1.5">
                  {[5000, 10000, 25000, 50000].map((val) => (
                    <button
                      ...
                      className="px-2 py-0.5 rounded-md bg-slate-100 hover:bg-orange-50 hover:text-orange-700 text-[10px] font-semibold text-slate-600 border border-slate-200/80 transition"
                    >
