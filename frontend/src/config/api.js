 ...
 * To bypass the direct URL and force relative proxy paths, NEXT_PUBLIC_DIRECT_API_URL or
 * NEXT_PUBLIC_API_URL can be configured.
 */

const PRODUCTION_BACKEND_URL = "https://lightcoral-turtle-931044.hostingersite.com";

const getApiUrl = () => {
  // If explicitly configured with direct or custom API URL
  if (typeof process !== "undefined") {
    if (process.env.NEXT_PUBLIC_DIRECT_API_URL !== undefined) {
